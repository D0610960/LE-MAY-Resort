...
<head>
    ...
    <meta http-equiv="refresh" content="1;url=https://localhost/NET/H_room.php">
...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-wide w3-padding w3-card">
            <a href="https://localhost/ET/Home.html" class="w3-bar-item w3-button"><b>LE MAY</b> RESORT</a>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php if ($result_room){ //delete success?>
