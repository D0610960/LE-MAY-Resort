...
//sql query : delete customer
$D_SSN = "Ssn = \"".$_GET['Ssn'];
$checkout_sql = "DELETE FROM customer
    WHERE  $D_SSN\"
    ";
$result_checkout = mysqli_query($con,$checkout_sql);
?>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            ...
            <?php if ($result_checkout){ //delete success?>
            <font class="font-montserrat " style="font-size=25px"><?php echo "Check-out SUCCEEDED !";?>
            </font>
            <?php } else{?>
            <font class="font-montserrat " style="font-size=25px"><?php echo "Check-out FAILED !";?>
            </font>
            <?php }
        mysqli_close($con);
        ?>
